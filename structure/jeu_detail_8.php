...
$graph_data=null;
$sql_graph_cat = "SELECT `evolution_note_type`,`evolution_note_type_nom`,count(*) as nbre,`jeu_bgg_note_bayesienne`\n"
    . "FROM `evolution_note` \n"
...
while($bdd_graph_cat = mysqli_fetch_object($res_graph_cat)){
    ...
    $graph_data.="],step: true,visible:".$visible.",},";
}
//var_dump("gg");
            ...
            <div class="d-flex justify-content-between align-items-start">
                ...
                <div >
                    ...
                    <table class="table well data">
                        <tbody><tr>
                            <td class="text-center"><i class="fas fa-users" data-bs-toggle="tooltip" data-bs-placement="left" title="Tooltip on left"></i></td>
                            <td itemprop="numberOfPlayers">2 - 4 players</td>
                        </tr>
                        <tr>
                            <td class="text-center"><i class="far fa-clock" data-toggle="tooltip" data-placement="left" title="" data-original-title="Average game duration"></i></td>
                            <td>average 30 minutes</td>
                        </tr>
                        <tr>
                            <td class="text-center"><i class="fas fa-balance-scale" data-toggle="tooltip" data-placement="left" title="" data-original-title="BGG Game weight"></i></td>
                            <td>
                                <div class="progress Casual">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="30.00" aria-valuemin="0" aria-valuemax="100" style="width: 30.00%;" data-toggle="popover" data-placement="bottom" data-content="1.50 / 5" data-original-title="" title="">
                                        Casual
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="text-center"><i class="far fa-calendar-alt" data-toggle="tooltip" data-placement="left" title="" data-original-title="Year published"></i></td>
                            <td>Published in <span itemprop="datePublished">2019</span></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
