...
//var_dump($bdd_category_stats);
    ...
    while($bdd_category_stats = mysqli_fetch_object($res_category_stats)){
        ...
        while($bdd_drilldown = mysqli_fetch_object($res_drilldown)){
            ...
            $data_drilldown.='<li class="list-group-item" style="text-align: left;padding-top: 0px;padding-bottom: 0px;">'.$bdd_drilldown->jeu_nom.'</li>';
            //$data_drilldown.='<li class="list-group-item" style="text-align: left;padding-top: 0px;padding-bottom: 0px;">Celestia</li>';
        }
        //$array_drilldown[]=array($bdd_category_stats->{$actu."_nom_en"},$data_drilldown);

        $graph_categoty_stats.='<div class="accordion-item">';
        $graph_categoty_stats.='<h2 class="accordion-header" id="header_'.$nom_jeu_format.'">';
        ...
        $graph_categoty_stats.='<div id="'.$nom_jeu_format.'" class="accordion-collapse collapse" aria-labelledby="header_'.$nom_jeu_format.'" data-bs-parent="#'.$actu.'">';
